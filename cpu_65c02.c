...
static const struct _instr_t _instrs[0x100] =
{
	...
	{ "RMB0", _zp,            2 },
	{ "PHP",  _implicit,      1 },
	{ "ORA",  _immediate,     2, _Z | _N },
	{ "ASL",  _a,             1, _Z | _N | _C },
	{ "",     _invalid,       1 },
	{ "TSB",  _absolute,      3, _Z },
	{ "ORA",  _absolute,      3, _Z | _N },
	{ "ASL",  _absolute,      3, _Z | _N | _C },
	{ "BBR0", _zp_relative,   3 },
	
	/* 0x1x */
	{ "BPL",  _relative,      2 },
	{ "ORA",  _zp_indirect_y, 2, _Z | _N },
	{ "ORA",  _zp_indirect,   2, _Z | _N },
	{ "",     _invalid,       1 },
	{ "TRB",  _zp,            2, _Z },
	{ "ORA",  _zp_x,          2, _Z | _N },
	{ "ASL",  _zp_x,          2, _Z | _N | _C },
	{ "RMB1", _zp,            2 },
	{ "CLC",  _implicit,      1 },
	{ "ORA",  _absolute_y,    3, _Z | _N },
	{ "INC",  _a,             1, _Z | _N },
	{ "",     _invalid,       1 },
	{ "TRB",  _absolute,      3, _Z },
	{ "ORA",  _absolute_x,    3, _Z | _N },
	{ "ASL",  _absolute_x,    3, _Z | _N | _C },
	{ "BBR1", _zp_relative,   3 },
	...
	{ "RMB2", _zp,            2 },
	{ "PLP",  _implicit,      1 },
	{ "AND",  _immediate,     2, _Z | _N },
	{ "ROL",  _a,             1, _Z | _N | _C },
	{ "",     _invalid,       1 },
	{ "BIT",  _absolute,      3, _Z },
	{ "AND",  _absolute,      3, _Z | _N },
	{ "ROL",  _absolute,      3, _Z | _N | _C },
	{ "BBR2", _zp_relative,   3 },
	
	/* 0x3x */
	{ "BMI",  _relative,      2 },
	{ "AND",  _zp_indirect_y, 2, _Z | _N },
	{ "AND",  _zp_indirect,   2, _Z | _N },
	{ "",     _invalid,       1 },
	{ "BIT",  _zp_x,          2, _Z },
	{ "AND",  _zp_x,          2, _Z | _N },
	{ "ROL",  _zp_x,          2, _Z | _N | _C },
	{ "RMB3", _zp,            2 },
	{ "SEC",  _implicit,      1 },
	{ "AND",  _absolute_y,    3, _Z | _N },
	{ "DEC",  _a,             1, _Z | _N },
	{ "",     _invalid,       1 },
	{ "BIT",  _absolute_x,    3, _Z },
	{ "AND",  _absolute_x,    3, _Z | _N },
	{ "ROL",  _absolute_x,    3, _N | _Z | _C },
	{ "BBR3", _zp_relative,   3 },
	...
	{ "RMB4", _zp,            2 },
	{ "PHA",  _implicit,      1 },
	{ "EOR",  _immediate,     2, _Z | _N },
	{ "LSR",  _a,             1, _Z | _N | _C },
	{ "",     _invalid,       1 },
	{ "JMP",  _absolute,      3 },
	{ "EOR",  _absolute,      3, _Z | _N },
	{ "LSR",  _absolute,      3, _Z | _N | _C },
	{ "BBR4", _zp_relative,   3 },
	...
	{ "ROR",  _zp,            2, _Z | _N | _C },
	{ "RMB6", _zp,            2 },
	{ "PLA",  _implicit,      1, _N | _Z },
	{ "ADC",  _immediate,     2, _N | _Z | _C | _V },
	{ "ROR",  _a,             1, _Z | _N | _C },
	{ "",     _invalid,       1 },
	{ "JMP",  _indirect,      3 },
	{ "ADC",  _absolute,      3, _N | _Z | _C | _V },
	{ "ROR",  _absolute,      3, _Z | _N | _C },
	{ "BBR6", _zp_relative,   3 },
	
	/* 0x7x */
	{ "BVS",  _relative,      2 },
	{ "ADC",  _zp_indirect_y, 2, _N | _Z | _C | _V },
	{ "ADC",  _zp_indirect,   2, _N | _Z | _C | _V },
	{ "",     _invalid,       1 },
	{ "STZ",  _zp_x,          2 },
	{ "ADC",  _zp_x,          2, _N | _Z | _C | _V },
	{ "ROR",  _zp_x,          2, _Z | _N | _C },
	{ "RMB7", _zp,            2 },
	{ "SEI",  _implicit,      1 },
	{ "ADC",  _absolute_y,    3, _N | _Z | _C | _V },
	{ "PLY",  _implicit,      1, _N | _Z },
	{ "",     _invalid,       1 },
	{ "JMP",  _indirect_x,    3 },
	{ "ADC",  _absolute_x,    3, _N | _Z | _C | _V },
	{ "ROR",  _absolute_x,    3, _Z | _N | _C },
	{ "BBR7", _zp_relative,   3 },
	...
	{ "STX",  _zp,            2 },
	{ "SMB0", _zp,            2 },
	{ "DEY",  _implicit,      1, _N | _Z },
	{ "BIT",  _immediate,     2, _Z },
	{ "TXA",  _implicit,      1, _N | _Z },
	{ "",     _invalid,       1 },
	{ "STY",  _absolute,      3 },
	{ "STA",  _absolute,      3 },
	{ "STX",  _absolute,      3 },
	...
	/* 0xAx */
	{ "LDY",  _immediate,     2, _Z | _N },
	{ "LDA",  _zp_indirect_x, 2, _Z | _N },
	{ "LDX",  _immediate,     2, _Z | _N },
	{ "",     _invalid,       1 },
	{ "LDY",  _zp,            2, _Z | _N },
	{ "LDA",  _zp,            2, _Z | _N },
	{ "LDX",  _zp,            2, _Z | _N },
	{ "SMB2", _zp,            2 },
	{ "TAY",  _implicit,      1, _Z | _N },
	{ "LDA",  _immediate,     2, _Z | _N },
	{ "TAX",  _implicit,      1, _Z | _N },
	{ "",     _invalid,       1 },
	{ "LDY",  _absolute,      3, _Z | _N },
	{ "LDA",  _absolute,      3, _Z | _N },
	{ "LDX",  _absolute,      3, _Z | _N },
	{ "BBS2", _zp_relative,   3 },
	
	/* 0xBx */
	{ "BCS",  _relative,      2 },
	{ "LDA",  _zp_indirect_y, 2, _Z | _N },
	{ "LDA",  _zp_indirect,   2, _Z | _N },
	{ "",     _invalid,       1 },
	{ "LDY",  _zp_x,          2, _Z | _N },
	{ "LDA",  _zp_x,          2, _Z | _N },
	{ "LDX",  _zp_y,          2, _Z | _N },
	{ "SMB3", _zp,            2 },
	{ "CLV",  _implicit,      1 },
	{ "LDA",  _absolute_y,    3, _Z | _N },
	{ "TSX",  _implicit,      1, _Z | _N },
	{ "",     _invalid,       1 },
	{ "LDY",  _absolute_x,    3, _Z | _N },
	{ "LDA",  _absolute_x,    3, _Z | _N },
	{ "LDX",  _absolute_y,    3, _Z | _N },
	{ "BBS3", _zp_relative,   3 },
	...
	{ "DEC",  _zp,            2, _Z | _N },
	{ "SMB4", _zp,            2 },
	{ "INY",  _implicit,      1, _Z | _N },
	{ "CMP",  _immediate,     2, _Z | _N | _C },
	{ "DEX",  _implicit,      1, _Z | _N },
	{ "WAI",  _implicit,      1 },
	{ "CPY",  _absolute,      3, _Z | _N | _C },
	{ "CMP",  _absolute,      3, _Z | _N | _C },
	{ "DEC",  _absolute,      3, _Z | _N },
	{ "BBS4", _zp_relative,   3 },
	...
	{ "INC",  _zp,            2, _Z | _N },
	{ "SMB6", _zp,            2 },
	{ "INX",  _implicit,      1, _Z | _N },
	{ "SBC",  _immediate,     2, _N | _Z | _C | _V },
	{ "NOP",  _implicit,      1 },
	{ "",     _invalid,       1 },
	{ "CPX",  _absolute,      3, _Z | _N | _C },
	{ "SBC",  _absolute,      3, _N | _Z | _C | _V },
	{ "INC",  _absolute,      3, _Z | _N },
	{ "BBS6", _zp_relative,   3 },
